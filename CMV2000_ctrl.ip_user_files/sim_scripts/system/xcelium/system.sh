...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../CMV2000_ctrl.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../CMV2000_ctrl.gen/sources_1/bd/system/ipshared/ee60/hdl" \
       +incdir+"../../../../CMV2000_ctrl.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../CMV2000_ctrl.gen/sources_1/bd/system/ipshared/ee60/hdl" \
       +incdir+"D:/ProgramFiles/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
       -input simulate.do
}
